    ...
    <footer className="relative bg-foreground text-background pt-16 pb-8 overflow-hidden">
      ...
      <div className="container relative">
        <div className="grid md:grid-cols-4 gap-10 mb-12">
          <div className="md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <div>
                ...
                <div className="text-[10px] text-background/60 tracking-widest uppercase">
                  Laundry • Dry Cleaning
                </div>
              </div>
            </div>
            <p className="text-background/70 text-sm max-w-md leading-relaxed mb-5">
              Nepal's trusted laundry & dry cleaning service. Treating every
              garment with the care it deserves — from your daily wear to your
              most precious occasion outfits.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-background/70">
              ...
              <li className="text-primary-glow font-semibold">
                8:00 AM – 8:00 PM
              </li>
              <li className="pt-2">Baluwakhani, Budhanilkantha</li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-background/10 pt-6 flex flex-col sm:flex-row gap-4 justify-between items-center text-xs text-background/50">
          <p>
            © {new Date().getFullYear()} Fresh and Clean Laundry & Dry Cleaning.
            All rights reserved.
          </p>
        </div>
      </div>
